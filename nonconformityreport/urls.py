...
urlpatterns = [
        ...
        path('registernonconformityreport/downloadpdfnoncon/<str:typereport>/<str:rep_id>/', views.downloadpdfnoncon, name='downloadpdfnoncon'),
        path('searchnonconformity/downloadpdfnoncon/<str:typereport>/<str:rep_id>/', views.downloadpdfnoncon, name='downloadpdfnoncon'),
